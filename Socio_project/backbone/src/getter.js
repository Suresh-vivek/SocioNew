...
document.getElementById("getterForm").addEventListener("submit", getterFormFunc);
function getterFormFunc(e) {
  ...
  var subjects_sci_g = getElementVal("subjects_sci_g");
  var subjects_math_g = getElementVal("subjects_math_g");
  var subjects_eng_g = getElementVal("subjects_eng_g");
  var subjects_hind_g = getElementVal("subjects_hind_g");
...
var getterDataSaver = (
  ...
  newGetterForm.set({
    ...
    phone_g: phone_g,
    age_g: age_g,
    subjects_sci_g: subjects_sci_g,
    subjects_math_g: subjects_math_g,
    subjects_eng_g: subjects_eng_g,
    subjects_hind_g: subjects_hind_g,
